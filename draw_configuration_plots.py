...
if high_shear_stiffness == True:
    ...
    ax[0].plot(t, q_pred[0,:], label='Seg. 1 Model', linewidth=2, color=color_palette[0], marker='s', mec='k', markevery=400)
    ax[0].plot(t, q_true[0,:], label='Seg. 1 GT', linewidth=3.5, linestyle='dotted', color=color_palette[0], alpha=0.6)
    ax[0].plot(t, q_pred[2,:], label='Seg. 2 Model', linewidth=2, color=color_palette[1], marker='s', mec='k', markevery=400)
    ax[0].plot(t, q_true[2,:], label='Seg. 2 GT', linewidth=3.5, linestyle='dotted', color=color_palette[1], alpha=0.6)
    ax[0].set_ylabel(r'$\kappa_{be}$ $[m^{-1}]$')
    ax[0].set_xlim([0,7.0])
    ax[0].grid(True)
    # ax[0].legend(loc='lower left', ncol=2)
    ...
    ax[1].plot(t, q_pred[1,:], label='Seg. 1 Model', linewidth=2, color=color_palette[0], marker='s', mec='k', markevery=400)
    ax[1].plot(t, q_true[1,:], label='GT', linewidth=3.5, linestyle='dotted', color=color_palette[0], alpha=0.6)
    ax[1].set_ylabel(r'$\sigma_{sh}$ [-]')
    ax[1].set_xlim([0,7.0])
    ax[1].grid(True)
    # ax[1].legend(loc='upper left', ncol=2)

    ax[2].plot(t, q_pred[3,:], label='Seg. 2 Model', linewidth=2, color=color_palette[1], marker='s', mec='k', markevery=400)
    ax[2].plot(t, q_true[3,:], label='GT', linewidth=3.5, linestyle='dotted', color=color_palette[1], alpha=0.6)
